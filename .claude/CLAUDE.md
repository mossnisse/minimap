...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-05 (commit e82439c). Confidence: 100%.
...
- `src/app/plugin/collection/PrivateCollectionManager.java` — 3 commits/90d
...
### Code health
Three co-equal signals: defect risk 6.32/10 avg, hotspot health 4.17/10 (stable), worst `src/app/service/SpecimenService.java` at 1.0/10 · maintainability 7.19/10 · performance risk 127 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
