...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-01 (commit 2901ae9). Confidence: 100%.
...
- `src/gis/ui/CsvEditorDialog.java` — 3 commits/90d
- `src/app/service/SpecimenService.java` — 5 commits/90d

### Code health
Three co-equal signals: defect risk 6.48/10 avg, hotspot health 3.35/10 (stable), worst `src/app/service/SpecimenService.java` at 1.0/10 · maintainability 7.11/10 · performance risk 165 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `src/gis/layers/ShapeFileLayer.java` — change entropy — impact −3.0
- `src/gis/core/Settings.java` — untested hotspot — impact −2.0
- `src/app/ui/GUI.java` — change entropy — impact −1.5
- `src/app/ui/GUI.java` — low cohesion (GUI) — impact −1.0
- `src/app/ui/SpecimenBridgeDialog.java` — low cohesion (SpecimenBridgeDialog) — impact −1.0
