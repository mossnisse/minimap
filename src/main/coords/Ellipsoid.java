...
public class Ellipsoid {
    // Semi-major axis (radius at equator)
    ...
    // Helmert 7-parameters for transformation to WGS84
    ...
    // Bessel 1841 what is the Helmert 7 parameters that is good for Sweden?
    public static final Ellipsoid BESSEL = new Ellipsoid(6377397.155, 1 / 299.15281285, 0,0,0,0,0,0,0);

    // Sweref99 uses the GRS80 elipsoid and should be geocentric but drifts from WGS84 due to plate tectonic, the shift is 8-9 dm.
